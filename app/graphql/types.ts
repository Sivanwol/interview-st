...
export type Slots = {
  ...
  reservationAt: Maybe<Scalars['String']>;
  table: RestTable
};
export type Reservations = {
  id: Scalars['ID'];
  sitAt?: Scalars['String'];
  leaveAt?: Scalars['String'];
...
export type Query = {
  tables: Array<RestTable>;
  table: Maybe<RestTable>;
  slots: Array<Slots>;
  reservation: Array<Reservations>;
  cancelableReservation: Maybe<Scalars["Boolean"]>
};
export type  QuestRestTableWhereIdConditionArgs = {
  id: Scalars['String']
}
export type QueryRestTableArgs = {
  orderBy?: InputMaybe<OrderRestTableBy>;
  orderDirection?: InputMaybe<OrderDirection>;
  skip?: InputMaybe<Scalars['Int']>;
  take?: InputMaybe<Scalars['Int']>;
};

export type CreateRestTableQuery = { table?: RestTable | null | undefined };
export type Mutation = {
  createReservation?: Maybe<CreateRestTableQuery>;
